        ...
        <table class="table align-middle">
            ...
            <?php foreach ($purchases as $purchase): ?>
                <tr>
                    ...
                    <td><?=getSmartphoneName($purchase->smartphone_id)?></td>

                    <td class="text-center">
                        <a type="button" class="btn btn-success btn-sm px-3 " href="/admin/edit/<?=$purchase->id?>">
                            <i class="bi bi-pencil-square"></i>
                        </a>
                    </td>

                    <td class="text-center">
                        <a type="button" class="btn btn-danger btn-sm px-3 " href="/admin/delete/<?=$purchase->id?>">
